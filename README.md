...
For the post-fire analysis, Sentinel-2 images with 15% cloud cover taken between July 3 and July 11 were used. For the pre-fire analysis, Sentinel-2 images with 15% cloud cover taken between June 15 and June 16 were used. The images were obtained through the Google Earth Engine platform, where NDVI and NBR indices were also calculated.
